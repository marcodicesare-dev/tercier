          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={arrChartData}>
                ...
                <Tooltip contentStyle={{ background: '#2A2018', border: '1px solid #3A3028', borderRadius: 8 }} />
                <Legend />
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={dilutionData}>
              ...
              <Tooltip contentStyle={{ background: '#2A2018', border: '1px solid #3A3028', borderRadius: 8 }} formatter={(v: any) => `${Number(v).toFixed(1)}%`} />
